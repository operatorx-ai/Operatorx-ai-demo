    ...
    if (targetScreen) {
        ...
        try {
            ...
            if (!industryContent[org]) {
                ...
                console.error('Industry content missing for selected org, falling back to Property Management. - script.js:1206');
            }
            // You can add more fallback logic here for other dynamic containers
        } catch (err) {
            console.error('Error rendering dynamic content: - script.js:1210', err);
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c🤖 OperatorxAI Demo Loaded - script.js:1666', 'font-size: 20px; color: #6366f1; font-weight: bold;');
    console.log('%cKeyboard Shortcuts: - script.js:1667', 'font-size: 14px; color: #8b5cf6;');
    console.log('Ctrl/Cmd + → : Next Screen - script.js:1668');
    console.log('Ctrl/Cmd + ← : Previous Screen - script.js:1669');
    console.log('ESC : Return to Home - script.js:1670');
    console.log('Ctrl/Cmd + Enter (in AI Input) : Execute Command - script.js:1671');
});
...
function switchOrganization(orgType) {
    ...
    console.log(`Switching to ${content.name}... - script.js:1679`);
    ...
    console.log(`✓ Switched to ${content.name} organization - script.js:1740`);
}
...
function loadIndustryScenario(scenarioKey) {
    ...
    if (!scenario) {
        console.error(`Scenario ${scenarioKey} not found for ${currentOrg} - script.js:1822`);
        return;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM Content Loaded  Initializing organization selector... - script.js:1838');
    ...
    setTimeout(() => {
        ...
        if (orgSelector) {
            orgSelector.addEventListener('change', function() {
                console.log('Organization changed to: - script.js:1845', this.value);
                switchOrganization(this.value);
            });
            
            // Initialize with default organization
            console.log('Initializing default organization: property - script.js:1850');
            switchOrganization('property');
        } else {
            console.error('Organization selector not found! - script.js:1853');
        }
    }, 100);
});
...
executeAI = async function() {
    ...
    if (!scenario) {
        console.error('No scenario found - script.js:1896');
        return;
    }
