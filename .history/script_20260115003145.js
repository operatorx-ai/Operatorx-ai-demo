...
const scenarios = {
    rent: {
        ...
        steps: [
            {
                ...
                content: "Parsed task: Recurring rent payment<br>Frequency: Monthly<br>Condition: Balance ≥ $2,000",
                status: "success",
                timestamp: "09:00:01"
            },
            {
                title: "Policy Validation",
                content: "Payment limits checked ✔<br>Account authorization verified ✔<br>Risk level: LOW",
                status: "success",
                timestamp: "09:00:02"
            },
            {
                title: "Balance Check",
                content: "Current balance: $3,420.17<br>Threshold met ✔",
                status: "success",
                timestamp: "09:00:03"
            },
            {
                title: "Decision",
                content: "Action approved<br>Scheduled for execution",
                status: "success",
                timestamp: "09:00:04"
            }
        ],
        result: {
            ...
            details: [
                ...
                { label: "Execution Date", value: "Feb 1, 2026" },
                { label: "Method", value: "ACH Transfer" },
                { label: "Status", value: "Approved" }
            ],
            note: "AI will re-evaluate conditions before every execution."
        }
    },
    bills: {
        ...
        steps: [
            {
                title: "Bill Detected",
                content: "Transaction feed scanned<br>3 utility bills identified",
                status: "success",
                timestamp: "10:30:01"
            },
            {
                title: "Category Assignment",
                content: "Bills categorized as: Utilities<br>AI confidence: 98%",
                status: "success",
                timestamp: "10:30:02"
            },
            {
            ...
            },
            {
                ...
                content: "3 payments queued<br>Confirmations logged",
                status: "success",
                timestamp: "10:30:04"
            }
        ]
    ...
    failure: {
        ...
        steps: [
            {
                ...
                content: "Rent payment: $1,450.00<br>Account balance: $1,280.50",
                status: "warning",
                timestamp: "09:00:01"
            },
            {
                title: "Failure Detected",
                content: "Insufficient funds identified<br>Transaction blocked",
                status: "danger",
                timestamp: "09:00:02"
            },
            {
                title: "Payment Halted",
                content: "Zero duplicate charge risk<br>Transaction reversed",
                status: "success",
                timestamp: "09:00:03"
            },
            {
        ...
        alert: {
            ...
            message: "Payment halted due to insufficient funds. Human review optional. No charges were processed.",
        ...
        scenarioContent.innerHTML = `
            <div class="result-card">
                <div class="result-header">
                    ...
                    <div class="result-title">${scenario.result.title}</div>
                </div>
