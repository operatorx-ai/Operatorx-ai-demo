// ===== INDUSTRY CONTENT FALLBACK =====
const industryContent = {
    property: {
        name: "Property Management",
        heroHeadline: "An AI Operator Built for <span class='gradient-text'>Property Management</span> Operations",
        heroSubheadline: "Watch AI prevent costly mistakes, save time, and execute operations autonomously",
        ctaMicro: "Demo behavior updates per organization type.",
