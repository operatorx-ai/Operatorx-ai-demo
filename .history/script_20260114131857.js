...
const demoData = {
    default: {
        ...
        executiveSummary: "Replace $45,000/year in administrative costs. Improve cash flow by 35%. Save 32 hours monthly.",
        problems: [
            "💸 Chasing unpaid invoices costs 8+ hours/week in lost time",
            "📊 Manual expense tracking leads to missed deductions and tax overpayment",
            "📅 Appointment no-shows cost $1,500-$3,000 monthly in lost revenue",
            "🤔 Lack of real-time financial visibility leads to poor decisions",
            "👋 Lost customers: 40% never return after first purchase (that's leaving money on the table)"
        ],
        automations: [
